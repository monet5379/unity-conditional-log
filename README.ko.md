...
- **데모:** `Assets/Demo` 놀이터. 스프라이트는 [Brackeys’ Platformer Bundle](https://brackeysgames.itch.io/brackeys-platformer-bundle) (CC0; analogStudios_, RottingPixels). `Assets/brackeys_platformer_assets/LICENSE & CREDITS.txt`.
